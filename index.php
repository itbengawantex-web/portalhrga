  ...
  <body class="m-0 font-sans antialiased font-normal bg-white text-start text-base leading-default text-slate-500">
    ...
    <nav class="absolute top-0 z-30 flex flex-wrap items-center justify-between w-full px-4 py-2 mt-6 mb-4 shadow-none lg:flex-nowrap lg:justify-start">
      <div class="container flex items-center justify-between py-0 flex-wrap-inherit">
        <a class="py-1.75 ml-4 mr-4 font-bold text-white text-sm whitespace-nowrap lg:ml-0"> Argon Dashboard 2 </a>
  ...
  <div class="flex flex-wrap -mx-3 -mt-48 md:-mt-56 lg:-mt-48">
    <div class="w-full max-w-full px-3 mx-auto mt-0 md:flex-0 shrink-0 md:w-7/12 lg:w-5/12 xl:w-4/12">
      <div class="relative z-0 flex flex-col min-w-0 break-words bg-white border-0 shadow-xl rounded-2xl bg-clip-border">
        ...
        <!-- HEADER -->
        <div class="p-6 pb-2 text-center bg-white border-b-0 rounded-t-2xl">

          <!-- Logo -->
          <svg class="w-12 h-12 mx-auto mb-2 text-zinc-700" fill="currentColor" viewBox="0 0 24 24">
          ...
          <!-- Didekatkan: mb-1 -->
          <p class="login-box-msg mb-1">Enter your Username and password to sign In</p>

          <?php
          if (isset($_SESSION['error'])) {
              echo '<div class="text-red-600 text-sm mb-3">'.$_SESSION['error'].'</div>';
          ...
          <form action="check_login.php" method="POST">
            ...
            <div class="mb-4">
              <input type="text" name="username"
                class="placeholder:text-gray-500 text-sm focus:shadow-primary-outline block w-full rounded-lg border border-gray-300 bg-white py-2 px-3"
            ...
            <div class="text-center">
              <button type="submit"
                class="inline-block w-full px-5 py-2.5 mt-4 mb-2 font-bold text-white rounded-lg bg-gradient-to-tl from-zinc-800 to-zinc-700">
                Sign In
              </button>
            </div>
          </form>
