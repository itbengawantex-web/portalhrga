          ...
          <div class="flex-none w-full max-w-full px-3">
            <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
              <div class="p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                <h6 class="dark:text-white">Tambah Training</h6>
                          ...
                          <div class="px-3">
                            ...
                            <div class="w-full px-3">
                              <div class="mb-4">
                                ...
                                <input type="text" name="judul_Training" placeholder="Judul Training" class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" required/>
                              </div>
                            </div>
                            <div class="w-full px-3">
                              <div class="mb-4">
                            ...
                            <div class="w-full px-3">
                              <div class="mb-4">
                                ...
                                <input type="text" name="durasi_jam" placeholder="Durasi Jam" class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" required/>
                              </div>
                            </div>
                            ...
                            <div class="w-full px-3">
                              <div class="mb-">
                               <button type="submit" name="simpan_training" class="w-full px-6 py-2  text-sm font-semibold text-white bg-blue-gradient rounded-lg hover:bg-green mr-2">Simpan</button>
                              </div>
                            </div>
                          </div>
                      </div>
